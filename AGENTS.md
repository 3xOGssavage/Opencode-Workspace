...
| `tavily`              | local               | Web search, crawl, deep research — vendored multi-key rotator (`.opencode/tools/tavily-rotator/`, reads `TAVILY_API_KEY_1..5`, auto-failover on 401/429/432, `/usage` health tool, default depth `basic`)                      |
