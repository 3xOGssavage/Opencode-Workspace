...
- `AIHUBMIX_API_KEY` (51 chars, `sk-...`) is set as a User env var — backs the `aihubmix/*` provider in `opencode.json` (43 models after `glm-5.2-free` exclusion via `scripts/sync-aihubmix-models.ps1`).
